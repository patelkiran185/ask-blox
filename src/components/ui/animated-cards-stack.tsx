...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-3 rounded-xl border border-stone-700/50 bg-accent-foreground/80 p-4 backdrop-blur-md",
      light:
        "flex size-full flex-col items-center justify-center gap-3 rounded-xl border  bg-accent bg-background/80 p-4 backdrop-blur-md ",
    },
  },
  defaultVariants: {
    variant: "light",
